...
export const Tracking = ({ onBack, onViewOrderDetails }: { onBack: () => void, onViewOrderDetails?: () => void }) => {
  return (
      ...
      <div className="mt-[84px] w-full">
          <div className="bg-white px-4 py-4 pt-6 mb-2 border-b border-gray-200 flex flex-col items-start gap-4">
               <div className="flex justify-between items-start w-full">
                   <h2 className="text-[22px] font-bold text-[#0f1111] leading-tight">
                       Arriving tomorrow by<br/>10 PM
                   </h2>
                   <span className="text-[#007185] font-medium text-[14px] cursor-pointer hover:underline">See all orders</span>
               </div>
               
               <img src="https://m.media-amazon.com/images/I/6182S7MYC2L._AC_SY200_.jpg" className="w-[80px] h-[80px] object-contain mt-2 mb-2 mix-blend-multiply" />
          </div>
          ...
          <div className="bg-white mb-2 border-y border-gray-200 pt-6 pb-6 w-full flex flex-col items-center shadow-sm">
               ...
               <div className="w-[85%] mx-auto relative h-8 flex items-center justify-between z-0 mb-6">
                   ...
                   <div className="absolute top-1/2 left-0 w-[50%] h-1.5 bg-[#007185] -mt-0.5 rounded-l-full z-[-1]" />
                   ...
                   <div className="flex flex-col items-center relative">
                       ...
                       <span className="text-[13px] font-bold text-[#007185] absolute top-7 w-20 text-center">Shipped</span>
                   </div>
